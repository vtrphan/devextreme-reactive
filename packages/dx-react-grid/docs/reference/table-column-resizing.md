...
```js
import { TableColumnResizing } from '@vtrphan/dx-react-grid-material-ui';
// import { TableColumnResizing } from '@vtrphan/dx-react-grid-bootstrap4';
// import { TableColumnResizing } from '@vtrphan/dx-react-grid-bootstrap3';
```

If you want to use custom components, you can import the themeless plugin:

```js
import { TableColumnResizing } from '@vtrphan/dx-react-grid';
```
...
minColumnWidth? | number | `45` for [Bootstrap3](https://www.npmjs.com/package/@vtrphan/dx-react-grid-bootstrap3); `55` for [Bootstrap4](https://www.npmjs.com/package/@vtrphan/dx-react-grid-bootstrap4); `40` for [Material-UI](https://www.npmjs.com/package/@vtrphan/dx-react-grid-material-ui); | Specifies a column's minimum width.
