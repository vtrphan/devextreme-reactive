## API Report File for "@vtrphan/dx-react-scheduler-material-ui"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { AllDayPanel as AllDayPanel_2 } from '@vtrphan/dx-react-scheduler';
import { AppointmentForm as AppointmentForm_2 } from '@vtrphan/dx-react-scheduler';
import { AppointmentMeta } from '@vtrphan/dx-react-scheduler';
import { AppointmentModel } from '@vtrphan/dx-react-scheduler';
import { Appointments as Appointments_2 } from '@vtrphan/dx-react-scheduler';
import { AppointmentTooltip as AppointmentTooltip_2 } from '@vtrphan/dx-react-scheduler';
import { ConfirmationDialog as ConfirmationDialog_2 } from '@vtrphan/dx-react-scheduler';
import { CurrentTimeIndicator as CurrentTimeIndicator_2 } from '@vtrphan/dx-react-scheduler';
import { DateNavigator as DateNavigator_2 } from '@vtrphan/dx-react-scheduler';
import { DayView as DayView_2 } from '@vtrphan/dx-react-scheduler';
import { DragDropProvider as DragDropProvider_2 } from '@vtrphan/dx-react-scheduler';
import { EditRecurrenceMenu as EditRecurrenceMenu_2 } from '@vtrphan/dx-react-scheduler';
import { GroupingPanel as GroupingPanel_2 } from '@vtrphan/dx-react-scheduler';
import { MonthView as MonthView_2 } from '@vtrphan/dx-react-scheduler';
import { Palette } from '@vtrphan/dx-react-scheduler';
import * as React_2 from 'react';
import { Resource } from '@vtrphan/dx-react-scheduler';
import { Scheduler as Scheduler_2 } from '@vtrphan/dx-react-scheduler';
import { TodayButton as TodayButton_2 } from '@vtrphan/dx-react-scheduler';
import { Toolbar as Toolbar_2 } from '@vtrphan/dx-react-scheduler';
import { ViewSwitcher as ViewSwitcher_2 } from '@vtrphan/dx-react-scheduler';
import { WeekView as WeekView_2 } from '@vtrphan/dx-react-scheduler';
