...
export const Layout = React.memo(
  ({
    setCellElementsMeta,
    cellComponent,
    allDayCellComponent = DefaultAllDayCellComponent,
    rowComponent: Row,
    allDayRowComponent: AllDayRow = DefaultAllDayRowComponent,
    cellsData,
    ...
    <LayoutBase
      ...
      {...restProps}
    >
      {prepareVerticalViewCellsData(cellsData, allDayCellsData).map(
        (group, groupIndex) => (
