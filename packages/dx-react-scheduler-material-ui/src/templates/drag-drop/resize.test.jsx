...
describe("DragDrop", () => {
  ...
  describe("Resize", () => {
    ...
    it("should manage classes by props", () => {
      ...
      tree = shallow(<Resize position="end" appointmentType="horizontal" />);

      expect(tree.is(`.${classes.horizontalEnd}`)).toBeTruthy();

      tree = shallow(<Resize position="end" appointmentType="vertical" />);
    ...
    it("should pass ref to the dom element", () => {
      ...
      expect(testRef.current).toEqual(resizeNode.getDOMNode());
    });
  });
});
