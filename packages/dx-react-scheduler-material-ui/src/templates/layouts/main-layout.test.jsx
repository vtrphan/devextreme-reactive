...
describe("Main Layout", () => {
  ...
  it("should render its components correctly", () => {
    ...
    expect(tree.find(`.${classes.stickyElement}`)).toHaveLength(3);
    expect(tree.find(`.${classes.flexRow}`)).toHaveLength(3);
    expect(tree.find(`.${classes.inlineFlex}`)).toHaveLength(2);
    expect(tree.find(`.${classes.leftPanel}`)).toHaveLength(2);
    expect(tree.find(`.${classes.dayScaleEmptyCell}`).exists()).toBeTruthy();
    expect(tree.find(`.${classes.background}`).exists()).toBeTruthy();
